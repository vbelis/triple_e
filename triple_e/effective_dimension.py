...
def empirical_fisher(p, dp):
    ...
    For some distribution p, some d distribution parameters theta, this
    function calculates the empirical fisher information matrix over k
